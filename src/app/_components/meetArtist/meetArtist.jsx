    ...
    return (
        <div className="flex flex-col lg:flex-row bg-gradient-to-r from-[#D9D9D9] via-[#F0F0F0] to-[#D9D9D9] p-4 min-h-80">
            ...
            <div className="ml-0 lg:ml-10 mt-14 lg:mt-0 w-full lg:w-2/3">
                <h1 className="text-gray-700 text-center text-xl sm:text-2xl md:text-3xl lg:text-5xl lg:mt-16 mb-4 pb-4 border-b-2 border-[#736356]">
                ...
                <div className="lg:mt-24">
                    ...
                    <p className="text-[#736356] mt-4 text-sm sm:text-base lg:text-lg lg:w-1/2 mx-auto lg:mx-0 text-right">
                        09/07/2024
                    </p>
                </div>
            </div>
